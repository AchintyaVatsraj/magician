...
we'll create a tunnel between  the  **Victim Machine**'s IP at port 6666 to one of our ports becuase we are on the same extrenal network , as long as  one of the users on the  **Victim Machine** binds this system's Port number 6666 to one of our systems network ports , technically we should be ablt to just goto our port and view the sensitive content. Please notes this is neat way to bypass some dumb firewalls solutions to perform horizontal Privilage Escalation and Sensitive Data Exposure.
